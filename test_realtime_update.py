...
def update_callback(table_name, timeframe_name, data, event_type):
    """更新コールバック（event_typeを受け取る）"""
    print(f"\n{'='*60}")
    print(f"[{event_type}] {timeframe_name}のデータ更新を受信！")
...
def main():
    print("\n=== Realtime UPDATE処理テスト ===\n")
    print("修正内容：")
    print("1. event_typeを正しく渡す")
    print("2. UPDATEイベントはタイムスタンプチェックをスキップ")
    print("3. 全てのUPDATEがローカルDBに保存される")
    print("\n5分間監視を続けます...\n")
